...
import { IMessageDocument, IOrderDocument, IOrderNotifcation, winstonLogger } from '@taylordurden/jobber-shared';
...
export class SocketIOAppHandler {
  ...
  constructor(io: Server) {
    ...
    this.chatServiceSocketIOConnections();
    this.orderServiceSocketIOConnections();
  }
  ...
  private chatServiceSocketIOConnections(): void {
  ...
  private orderServiceSocketIOConnections(): void {
