...
import { IHitsTotal, IPaginateProps, IQueryList, ISearchResult, ISellerGig } from '@taylordurden/jobber-shared';

export async function getGigById(index: string, gigId: string): Promise<ISellerGig> {
