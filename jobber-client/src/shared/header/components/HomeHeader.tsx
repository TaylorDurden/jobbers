...
import { FaBars, FaRegBell, FaRegEnvelope, FaTimes } from 'react-icons/fa';
import { Transition } from '@headlessui/react';

import { categories, replaceSpacesWithDash, showSuccessToast, showErrorToast } from 'src/shared/utils/utils.service';
